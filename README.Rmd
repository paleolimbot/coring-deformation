...
knitr::opts_chunk$set(dpi=150, echo=FALSE, warning=FALSE, message=FALSE, fig.path="autofig/fig_")
...
```{r, fig.cap="*Fig. 5* Distribution of d~0~ for d=0 by degree of deformation. Value a=0 indicates no deformation; a=.4 indicates maximum deformation in model. Coordinates are in cetimeters."}
...
```{r, fig.cap="*Fig. 6* Distribution of d~0~ of a vertical sliced section for multiple degrees of deformation and slice sizes. Coordinates are in centimeters.", fig.height=2}
# side on view
