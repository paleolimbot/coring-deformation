...
![Fig. 1. Schematic of variables used in the deformation model.](figs/fig2_deformation_vars.png)

```{r, fig.cap="Fig. 2. Histogram of deformation coefficients from digitized layers."}
...
plot_layer("cheak2.2", title="cheak2.2 (a=0.40)") # 0.4

plot_layer("whistler_gc8.1", title="whistler_gc8.1 (a=0.10)") # 0.1
plot_layer("cheak1.7", title="cheak1.7 (a=0.19)") # 0.2
plot_layer("suzielake_2.9", title="suzielake_2.9 (a=0.41)") # 0.4
par(op); rm(op)
```

```{r, fig.cap="Fig. 4. Distribution of d~0~ for d=0 by deformation coefficient."}
...
```{r, fig.cap="Fig. 5. Distribution of d~0~ of a vertical sliced section for multiple deformation coefficients and slice sizes.", fig.height=2}
# side on view
...
```{r, fig.cap="Fig. 6. Distribution of d~0~ values modelled for multiple deformation coefficients and slice sizes."}
...
```{r, fig.cap="Fig. 7. Extrusion and deformation modelled for artificial 0.5 mm resolution concentration data."}
